...
| 2-1 Poll 數值 | `Master Poll` 按 `Read AI`。 | `Polled AI` 顯示兩個 DNP3 ID 的啟用 AI 點：AI_0..AI_30 與 AI_32；AI_0..AI_11 與現場電表一致。 | AI_31 是 Spare，預設停用。PV Logger payload 使用工程值，Outstation 會轉 DNP raw。 |
